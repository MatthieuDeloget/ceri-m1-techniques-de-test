...
public final class Pokemon extends PokemonMetadata {
	...
	/** Combat Point getter.
	 * @return Combat Points of the Pokemon.
	 * **/
	public int getCp() {
		return cp;
	}
	...
	/** Dust getter.
	 * @return The dust used on the Pokemon.
	 * **/
	public int getDust() {
		return dust;
	}
	...
	/** Candy getter. 
	 * @return How many candies has this Pokemon consumed.
	 * **/
	public int getCandy() {
		return candy;
	}
